...
import { Upload, Folder, MoreVertical, FileText, ImageIcon, Video } from 'lucide-react';
...
const MainContent: React.FC<MainContentProps> = ({ user }) => {
  const { recentFiles, loading: filesLoading, error: filesError } = useRecentFiles(user.$id);
